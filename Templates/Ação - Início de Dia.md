...
// 2. Criar/Atualizar Diário de Obra com as Tarefas
...
## 📝 Planeamento do Dia (Definido no Início)
${listaTarefas}
...
new Notice(`✅ Início de Dia concluído para ${obra}! Presenças e Diário criados.`, 5000);
%>
